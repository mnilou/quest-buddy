          ...
          <div class="row" style={{height: '15em'}}>
            ...
            <div class="col-1 border">
              <button
                ...
                style={{height: '15em', display: 'block'}}
              >
                Create New Event
              </button>
            </div>
        ...
        <div class="col">
          <div class="row mt-2">
            <div class="col-md-6 overflow-auto border" style={{height: '15em'}}>
              <p class="mt-2"></p>
              <p>
                Up on the mountain is a house by a cemetary, haunted by the
                memories of atrocities past. The cult on the mountain is long
                gone, yet the music of weidling death carries on the wind.
              </p>
              <p>The mountain is cold. So very cold.</p>
              <p>
                And the greedy and the foolish will march bravely up the
                mountain for gold and glory.
              </p>
            </div>
            <div class="col-md-6 overflow-auto border" style={{height: '15em'}}>
              <p>
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-text">Level: 8 / Barbarian / Dark Elf</p>
                    <button onClick={characterPageClick} class="btn btn-danger">
                      Go to Character
                    </button>
                  </div>
                </div>
              ...
              <p>
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-text">Level: 2 / Druid / Human</p>
                    <button onClick={characterPageClick} class="btn btn-danger">
                      Go to Character
                    </button>
                  </div>
              ...
              <p>
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-text">Level: 12 / Necromancer / High Elf</p>
                    <button onClick={characterPageClick} class="btn btn-danger">
                      Go to Character
                    </button>
                  </div>
