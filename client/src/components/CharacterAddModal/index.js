  ...
  return (
    ...
    >
      <form className="modal-main">
        <h4 className="p-3 bg-light">
          Select One of Your Existing Characters to Add to This Campaign
        </h4>
        <div className="form-group m-2">
          <label htmlFor="character-select" className="pr-2">
          ...
          {props.userCharacters.length === 0 ? (
            ...
            <select
              ...
              onChange={props.handleInputChangeCharacterAdd}
            >
