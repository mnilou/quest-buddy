...
app.post("/api/character/equipment", (req, res) => {
    db.Character.findById(req.body.id).then(results => {
        // console.log(req.body.equipment.equipment_category.index)
        // console.log(results.gear)
        // console.log(req.body.equipment)
        switch (req.body.equipment.equipment_category.index) {
            case "adventuring-gear":
                console.log('gear')
                results.gear.push(req.body.equipment);
                // gear.push(req.body.equipment);
                break;
            case "tools":
                console.log("tools")
                results.tools.push(req.body.equipment);

                // tools.push(req.body.equipment);
                // console.log(tools)
                break;
            case "weapon":
                console.log("weapon")
                results.weapons.push(req.body.equipment);
                // weapons.push(req.body.equipment);
                break;
            case "armor":
                console.log("armor")
                results.armor.push(req.body.equipment);
                // armor.push(req.body.equipment);
                break;
            default:
                break;
        }
